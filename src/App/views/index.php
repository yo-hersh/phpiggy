...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <form method="GET" class="mt-4 w-full">
        <div class="flex">
            <input name="s" type="text" value="<?php echo e($searchTerm ?? ''); ?>"
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
            <?php foreach ($transactions as $transaction):
                ...
                <tr>
                    ...
                    <!-- Receipt List -->
                    <td class="p-4 text-sm text-gray-600">
                        <?php foreach ($transaction['receipt'] as $receipt): ?>
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="-mt-px flex w-0 flex-1">
            <?php if ($currentPage > 2): ?>
                <a href="/?<?php echo e($firstPageQuery) ?>"
        ...
        <div class="-mt-px flex w-0 flex-1 justify-end">
            <?php if ($currentPage < $lastPage - 1): ?>
                <a href="/?<?php echo e($lastPageQuery) ?>"
                    class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                    <?php echo e($lastPage); ?>
                    <svg class="ml-3 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd"
